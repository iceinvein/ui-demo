...
function DockIcon({
	...
	return (
		...
		>
			<div className="-top-10 pointer-events-none absolute rounded-md bg-default-900/90 px-2.5 py-1 text-default-50 text-xs opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
				{label}
				<div className="-translate-x-1/2 absolute top-full left-1/2 border-4 border-transparent border-t-default-900/90" />
			</div>
			<motion.div
	...
	return (
		...
		>
			...
			<motion.div
				...
				className="flex items-end gap-2 rounded-2xl border border-default-200/60 bg-default-100/50 px-4 pt-2 pb-2 shadow-xl backdrop-blur-xl"
